        	...
        	<div class="row">
        		...
        		<div class="col">
		   			<label for="modal-nome">
		    			<p>Nome:
		    				<input class="form-control" type="text" id="modal-nome" placeholder=" ex.: Fulano da Silva" size="25" maxlength="50" required />
		   				</p>
		   			</label>
        		</div>
        	</div>
        	<div class="row">
		    	<div class="col"> 
		    		<label for="modal-cpf">
		   			...
		   			<label for="modal-rg">
		    			<p>RG:
		    				<input class="form-control" type="text" id="modal-rg" placeholder=" ex.: 12.345.678-99" size="15" maxlength="15" required />
		   				</p>
		   			</label>
	   			</div>
	   		</div>
	   		<div class="row">
		   			<div class="col">
				   		<label for="modal-email">
			    			<p>E-mail:
			    				<input class="form-control" type="text" id="modal-email" placeholder=" ex.: seunome@algumacoisa.com.br" size="30" maxlength="50" required />
			   				</p>
			   			</label>
				   		<label for="modal-telefone">
			    			<p>Telefone:
			    				<input class="form-control" type="text" id="modal-telefone" placeholder=" ex.: (11) 99999-9999" size="15" maxlength="15" required />
			   				</p>
			   			</label>
		   			</div>
		   		</div>
